...
<div class="container">
	...
	<div class="row">
		<div class="span6">
			...
			<p style="text-align:center; margin-top:20px"> <a class="btn btn-large btn-primary jumbo" href="https://github.com/schnawel007/bootstrap3-wysihtml5">View project on Github</a> </p>
		</div>
		<div class="span6" >
			<h2>Usage</h2>
			<p>
